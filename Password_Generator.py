...
alphabet = string.hexdigits + string.ascii_letters + \
...
Button(root, text='Generator', bg='#ffe161', fg='#0f7699', font=('Cooper', 12,
       'normal'), command=btnClickFunction).place(x=5, y=115, width=420, height=40)
Label(root, text='Password generator', bg='#0f7699', fg='#ffffff',
      font=('Goudy Stout', 14, 'normal')).place(x=5, y=5)


# This is the section of code which creates the a label
Label(root, text='What length password to be:', bg='#0f7699',
      fg='#ffffff', font=('Arial Rounded MT', 12, 'normal')).place(x=5, y=50)


# This is the section of code which creates the a label
Label(root, text='How many passwords would you like:', bg='#0f7699',
      fg='#ffffff', font=('Arial Rounded MT', 12, 'normal')).place(x=5, y=75)
...
Label(root, text='GPL-3.0 License', bg='#0f7699', fg='#ffffff',
      font=('arial', 12, 'normal')).place(x=5, y=400)
link2 = Label(root, text=r'alij.cc', bg='#0f7699', fg='#ffffff',
...
Button(root, text='QUIT', bg='#ffe161', fg='#0f7699', font=(
    'arial', 12, 'normal'), command=quit).place(x=200, y=400, width=50)
